...
# ==========================================
    ...
    # CORRECTED Garrett Track A: MM-Only Growth Multiplier (Excludes g_direct)
    ...
    # CORRECTED Garrett Track B: Personal Hunter Accelerator ($100/car > 125, strict condition)
